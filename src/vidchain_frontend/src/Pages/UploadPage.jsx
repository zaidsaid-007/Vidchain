...
import {Button,TextField,Box,Typography,Select,MenuItem,FormControl,InputLabel,CircularProgress,LinearProgress,} from "@mui/material";
...
const UploadPage = () => {
  ...
  return (
    <Box sx={{ p: 4, color: "white" }}>
      ...
      <Box
        sx={{ mt: 4, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4 }}
      >
        {/* Upload Zone */}
        ...
        >
          ...
          <TextField
            ...
            onChange={(e) =>
              setUploadData({ ...uploadData, channel: e.target.value })
            }
            sx={textFieldStyle}
          />
          <TextField
            ...
            onChange={(e) =>
              setUploadData({ ...uploadData, duration: Number(e.target.value) })
            }
            sx={textFieldStyle}
          />
